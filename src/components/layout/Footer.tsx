      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-12 md:py-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg font-bold text-white mb-1">Karanvir Singh</h3>
            <p className="text-sm text-[#666]">Building • Learning • Creating</p>
          </div>
            ...
            {socialLinks.map(({ icon: Icon, href, label }) => (
              <a
                ...
                className="
                  ...
                  text-[#666] hover:text-[#00d4ff] hover:border-[#00d4ff]/30
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.04] text-center">
          <p className="text-xs text-[#444]">© 2026 Karanvir Singh</p>
        </div>
      </div>
    </footer>
  );
